...
public class HomeController {
    ...
    public String calculate(@RequestParam String leftOperand,
	    ...
	    model.addAttribute("leftOperand", new DecimalFormat("#.######").format(calculator.getLeftOperand()));
	    model.addAttribute("operator", calculator.getOperator());
	    model.addAttribute("rightOperand", new DecimalFormat("#.######").format(calculator.getRightOperand()));

	    model.addAttribute("result", new DecimalFormat("#.######").format(result));
	    model.addAttribute("view", "views/calculatorForm");
